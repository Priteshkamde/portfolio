...
import cafe_api_walk_through from '../assets/projectimages/cafe_api_walk_through.gif'
    ...
    return (
        <Container fluid={true} className='px-3'>
            <Hero title={props.title} />
                ...
                <Card className="p-3 mx-2 shadow border-0" style={snackCard} key={data.id}> 
                <Row className="">

                <Col xs={12} sm={12} md={12} lg={6} className=''> 
                    <h1 className="display-4">{data.name}</h1> 
                    <Image src={data.imageLink} alt="cafe-api-walk-through" style={{width : '100%'}} fluid rounded />
                </Col> 
